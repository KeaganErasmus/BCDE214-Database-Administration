...
DROP PROCEDURE IF EXISTS bulkLoadPlaces
GO
...
DELETE FROM Place
SELECT * FROM Place
EXEC bulkLoadPlaces @fileName = 'D:\BCDE214\BCDE214-Database-Administration\Assignment3\Portfolio2022\Vaccine2021Data\Sites.csv'
SELECT * FROM Place